...
import { ReactComponent as GainerIcon } from "../assets/img/GainerIcon.svg"
        ...
        <div style={{ width: 545 }}>
          ...
          >
            ...
            {dailyGainersList && dailyGainersList.map((group: any, index: number) => {
              return <React.Fragment key={`${index}-frag`}>
                <Row key={`${index}-row`} style={{ flexWrap: 'nowrap' }}>
                  {group.map((dailyGainer, index: number) => {
